...
const TermsPage = () => {
  return (
    <div className='md:px-60 px-10 py-20'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Cancellations and Refund of Participation Fee</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
        <li>Participation fee cancellations and refund will only be entertained in case of any emergencies or sensible reasoning. To process any cancellations, you are required to email us at streetfury@minus01.com.</li>
        <li>Refunds for cancellations will be processed in accordance with the organisers’ terms.</li>
      </ul>

      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Rules of Conduct</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Health and Safety</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Equipment and Apparel</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Liability and Waiver</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Media and Intellectual Property</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Prizes and Awards</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <h2 className='font-assistant font-semibold mt-10 text-2xl'>Dispute Resolution</h2>
      <ul className='list-disc space-y-5 mt-5 pl-5'>
      ...
      <p className='font-assistant mt-10 text-xl'>
        For further enquiries, please contact <a href="mailto:streetfury@minus01.com" className='text-blue-500'>streetfury@minus01.com</a>.
      </p>
    </div>
  );
};
